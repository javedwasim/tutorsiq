...
@section('htmlheader_title')
    ...
    <?php if($status != 'add'): ?>
    {{ trans('Admin | Teacher | Subject | Update') }}
    <?php else: ?>
    {{ trans('Admin | Teacher | Subject | Add') }}
    <?php endif; ?>
@endsection
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="box box-info">
                    <!-- form start -->
                    <form class="form-horizontal" id="preference" method="post" action="{{ url('admin/subject/save') }}"
                          enctype="multipart/form-data">
                        <input type="hidden" name="_token" value="{{ csrf_token() }}">
                        <input type="hidden" name="status" id="status"
                               value="<?php echo isset($status) ? $status : ''; ?>">
                        <input type="hidden" name="id" id="id"
                               value="<?php echo isset($subject->id) ? $subject->id : '';?>">
                                ...
                                <div id="qualification" class="panel-collapse collapse in" role="tabpanel"
                                    ...
                                    <div class="box-body">
                                        ...
                                        <div class="form-group">
                                            <label for="gender_id" class="col-sm-2 control-label">Subject<span
                                                        style="color: red">*</span></label>

                                            <div class="col-sm-10">
                                                <input type="text" class="form-control" id="name"
                                                       value="<?php echo isset($subject->name) ? $subject->name : ''; ?>"
                                                       name="name" placeholder="Enter Subject Name" maxlength="100"
                                                       required>
                                            </div>
                                        </div>

                                        <div class="box-footer">
                                            <a href="{{url('admin/subjects')}}" class="btn btn-warning pull-right">
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        if (success == 'saveandadd') {
                            ...
                            var redirect_url = '{{url("admin/subject/add")}}';
                            toastr.success('Subject Save Successfully!');

                        } else {

                            var redirect_url = '{{url("admin/smessage")}}';
