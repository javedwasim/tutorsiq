        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="box box-info">
                    <!-- form start -->
                    <form class="form-horizontal" id="preference" method="post" action="{{ url('admin/teacher/preferences') }}"
...
@section('page_specific_inline_scripts')
    <script>
        ...
        $( ".target" ).change(function() {
            ...
            $.ajax({
                url:'{{url("admin/class/subject/load/mappings")}}',
                type: "POST",
        ...
        jQuery( document ).ready( function( $ ) {
            ...
            $( '#preference' ).on( 'submit', function(e) {
                ...
                $.ajax({
                    ...
                    url:'{{url("admin/teacher/preferences")}}',
                    type: "POST",
                    data: formData,
                    async: false,
                    beforeSend: function(){
