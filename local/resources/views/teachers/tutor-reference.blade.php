...
@section('htmlheader_title')
    ...
    <?php if($status != 'add'): ?>
    {{ trans('Teacher | Reference | Update') }}
    <?php else: ?>
    {{ trans('Teacher | Reference | Add') }}
    <?php endif; ?>
@endsection
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="box box-info">
                    <!-- form start -->
                    {!! Form::open(array('url'=>'teacher/references','method'=>'POST', 'id'=>'reference',
                        ...
                        <div class="box-footer">
                            <a href="{{url('references')}}" class="btn btn-warning pull-right">
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        if(success=='saveandadd'){
                            ...
                            var redirect_url = '{{url("teacher/references")}}';
                            ...
                            var redirect_url = '{{url("references")}}';
                            $( ".modal-footer" ).append( $( '<a class="btn btn-outline" ' +
