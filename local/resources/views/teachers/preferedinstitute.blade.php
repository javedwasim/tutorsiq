<div class="box box-primary">
    <a href="#">
        ...
        margin-top: 5px;"></i>
            ...
            <h1 class="box-title">Preferred Institutes List</h1>
        </div>
    </a>
            ...
            <div class="col-xs-12">
                <div class="box" style="border-top: none;">
                    ...
                    <div class="box-header">
                        <a href="{{'institutes/add'}}" class="btn btn-primary pull-right">
                            ...
                            <table class="table table-hover" id="qualification">
                                ...
                                <tr>
                                    ...
                                    <td style="text-align: right">
                                        ...
                                        <a class="btn  del-btn"
                                           href="institute/delete/<?php echo $e->id; ?>" title="Delete"
