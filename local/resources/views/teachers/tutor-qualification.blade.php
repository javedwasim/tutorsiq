...
@section('htmlheader_title')
    ...
    <?php if($status != 'add'): ?>
    {{ trans('Teacher | Qualification | Update') }}
    <?php else: ?>
    {{ trans('Teacher | Qualification | Add') }}
    <?php endif; ?>
@endsection
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="box box-info">
                    <!-- form start -->
                    {!! Form::open(array('url'=>'/teacher/qualifications','method'=>'POST', 'id'=>'qualification',
                    ...
                    <div class="box-footer">
                        <a href="{{url('qualifications')}}" class="btn btn-warning pull-right">
    ...
    <script>
        ...
        jQuery(document).ready(function ($) {
            ...
            $('#qualification').on('submit', function (e) {
                ...
                $.ajax({
                    url: '{{url("teacher/qualifications")}}',
                    type: "POST",
                    data: formData,
                    async: true,
                    beforeSend: function () {
                    ...
                    success: function (data) {
                        ...
                        if (success == 'saveandadd') {
                            ...
                            var redirect_url = '{{url("teacher/qualifications")}}';
