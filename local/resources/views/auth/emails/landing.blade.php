...
<div id="navigation" class="navbar navbar-default navbar-fixed-top">
    <div class="container">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="#"><b>Home Tuition</b></a>
        </div>
...
<div id="headerwrap">
    <div class="container">
        <div class="row centered">
            <div class="col-lg-12">
                <h1>Registration <b><a href="#">Almost Done</a></b></h1>

                <h3>
                    We've sent an email to <a href="#"><?php echo isset($email) ? $email:''; ?></a> Please open it up to activate your account.
...
<div id="c">
    <div class="container">
        <p>
            ...
            <a href="http://acacha.org/sergitur">Sergi Tur Badenas</a>. {{ trans('adminlte_lang::message.seecode') }} <a
