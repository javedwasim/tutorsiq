            ...
            <form class="form-horizontal" id="templater" method="post" action="{{ url('admin/teacher/bulk/email') }}"
                ...
                <div class="box-body" style="display: block;">
                    ...
                    <div class="form-group">
                        <label for="title" class="col-sm-2 control-label">Email Template<span
                                    style="color: red">*</span></label>

                        <div class="col-sm-10">
                            <select class="form-control target select2" data-placeholder="Select Template"
                    ...
                    <div class="form-group">
                        <label for="body" class="col-sm-2 control-label">Send Email To<span style="color: red">*</span></label>

                        <div class="col-sm-10">
                            <input type="radio" name="email_type" id="email_type" value="all"
                            <?php echo isset($email_type) && ($email_type == 'all') ? 'checked' : ''; ?> >&nbsp;All Teachers
                            &nbsp;

                            <input type="radio" name="email_type" id="email_type" value="bulk"
                            <?php echo isset($email_type) && ($email_type == 'bulk') ? 'checked' : ''; ?> >&nbsp;Global Teachers List

                            <input type="radio" name="email_type" id="email_type" value="approved"
                            <?php echo isset($email_type) && ($email_type=='active') ? 'checked' : ''; ?> >&nbsp;Approved Teachers
                            &nbsp;

                            <input type="radio" name="email_type" id="email_type" value="napproved"
                            <?php echo isset($email_type) && ($email_type=='active') ? 'checked' : ''; ?> >&nbsp;Not Approved Teachers
                            &nbsp;
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <textarea class="form-control" rows="10" name="body"  placeholder="Enter ..." required></textarea>
                        </div>
                    </div>
