...
@section('htmlheader_title')
    ...
    @endrole
    <?php if($status == 'Experience'): ?>
        {{ trans('Admin | Teacher | Experience | Docs') }}
    <?php endif; ?>
@endsection

@section('contentheader_title')
    <?php if($status == 'Experience'): ?>
        {{ trans('Teacher Experience Documents') }}
    <?php endif; ?>
@endsection
                    ...
                    <div id="accordion" role="tablist" aria-multiselectable="true">
                        <div class="panel panel-default">
                            ...
                            <div id="qualification" class="panel-collapse collapse in" role="tabpanel"
                                ...
                                <div class="box-body">
                                    <img src="<?php  echo url("/local/teachers/".$teacherid."/experience/".$docname); ?>" alt="Teacher Documents" width="100%">
                                </div>
                            </div>
                        </div>
                    </div>
