...
@section('htmlheader_title')
    ...
    <?php if($status != 'add'): ?>
    {{ trans('Admin | Teacher | Experience | Update') }}
    <?php else: ?>
    {{ trans('Admin | Teacher | Experience | Add') }}
    <?php endif; ?>
@endsection
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="box box-info">
                    <!-- form start -->
                    {!! Form::open(array('url'=>'/admin/teacher/experience','method'=>'POST', 'id'=>'experience',
...
@section('page_specific_inline_scripts')
    <script>
        ...
        jQuery(document).ready(function(){
            ...
            jQuery('.btn-experience').on('click', function(event) {
                jQuery('.experience-image').toggle('show');
            });
        ...
        jQuery( document ).ready( function( $ ) {
            ...
            $( '#experience' ).on( 'submit', function(e) {
                ...
                $.ajax({
                    url:'{{url("admin/teacher/experience")}}',
                    type: "POST",
                    data: formData,
                    async: true,
                    beforeSend: function(){
                    ...
                    success: function (data) {
                        ...
                        if(success=='saveandadd'){
                            ...
                            var redirect_url = '{{url("admin/teacher/experience/add/")}}/'+teacherid;
                            window.location.replace(redirect_url);
                            toastr.success('Experience Save Successfully!');
