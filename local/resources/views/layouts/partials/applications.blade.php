...
<div class="box box-primary">
    ...
    margin-top: 5px;"></i>
        ...
        <h1 class="box-title">Status List</h1>
    </div>
        ...
        <div class="row">
            <div class="col-xs-12">
                ...
                <div class="box">
                    ...
                    <form class="" method="post" action="{{ url('admin/application/status') }}" id="filterform">
                    ...
                    <div class="box-header">
                        <a href="{{ url('admin/application/status/add') }}" class="btn btn-primary pull-right">
                    ...
                    <div class="box-body">
                        <table id="example1" class="table table-bordered table-striped" cellspacing="0" width="100%">
                            ...
                            <tbody>
                            <?php foreach($applicationStatus as $status): ?>
                            <tr>

                                <td><?php echo $status->name; ?></td>
                                <td><?php echo $status->description; ?></td>
                                <td><?php echo $status->sms_description; ?></td>
                                <td>
                                    <a class="btn  edit-btn" href="status/update/<?php echo $status->id; ?>"
                                       title="Edit" style="padding: 0 0;">
                                        <span class="label label-success">
                                            <i class="fa fa-fw fa-edit" style="font-size: 10px;"></i>
                                        </span>
                                    </a>
                                    <a class="btn  del-btn" href="status/delete/<?php echo $status->id; ?>"
                        ...
                        <div class="box-footer">
                            ...
                            <?php echo $applicationStatus->render(); ?>
