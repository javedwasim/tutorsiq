...
<div class="box box-primary">
    ...
    <div class="box-header with-border">
        ...
        margin-top: 5px;"></i>
        <h1 class="box-title">Referrers List</h1>
    </div>
        ...
        <div class="row">
            <div class="col-xs-12">
                ...
                <div class="box">
                    ...
                    <form class="" method="post" action="{{ url('admin/referrers') }}" id="filterform">
                    ...
                    <div class="box-header">
                        <a href="{{ url('admin/referrer/add') }}" class="btn btn-primary pull-right">
                    ...
                    <div class="box-body">
                        <table id="example1" class="table table-bordered table-striped" cellspacing="0" width="100%">
                            ...
                            <tr>
                                ...
                                <td>
                                    <a class="btn  edit-btn" href="referrer/update/<?php echo $referrer->id; ?>" title="Edit" style="padding: 0 0;">
                                        <span class="label label-success">
                                            <i class="fa fa-fw fa-edit" style="font-size: 10px;"></i>
                                        </span>
                                    </a>
                                    <a class="btn  del-btn" href="referrer/delete/<?php echo $referrer->id; ?>" onclick="return ConfirmDelete();"
