...
<div class="box box-primary">
    ...
    <div class="box-header with-border">
        ...
        margin-top: 5px;"></i>
        <h1 class="box-title">Subject/Grades</h1>
    </div>
        ...
        <div class="row">
            <div class="col-xs-12">
                ...
                <div class="box">
                    ...
                    <form class="" method="post" action="{{ url('admin/tuition/categories') }}" id="filterform">
                    ...
                    <div class="box-header">
                        <a href="{{ url('admin/tuition/category/add') }}" class="btn btn-primary pull-right">
                    ...
                    <div class="box-body">
                        <table id="example1" class="table table-bordered table-striped" cellspacing="0" width="100%">
                            ...
                            <tr>
                                ...
                                <td>
                                    <a class="btn  edit-btn" href="category/update/<?php echo $category->id; ?>" title="Edit" style="padding: 0 0;">
                                        <span class="label label-success">
                                            <i class="fa fa-fw fa-edit" style="font-size: 10px;"></i>
                                        </span>
                                    </a>
                                    <a class="btn  del-btn" href="category/delete/<?php echo $category->id; ?>" onclick="return ConfirmDelete();"
                        ...
                        <div class="box-footer">
                            ...
                            <div class="" style="display:inline-block;">Showing
                                ...
                                <?php echo $count_categories; ?> entries
                            </div>
                        </div>
                    </div>
                    <!-- /.box-body -->
