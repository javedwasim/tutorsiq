...
<div class="box box-primary collapsed-box">
    ...
    <div class="box-body">
        <!-- form start -->
        <form class="" method="post" action="{{ url('admin/teachers/matched/') }}<?php echo "/".$tuitionid; ?>" id="filterform">
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        <div class="checkbox">
                            ...
                            <label style="margin-left: 10px;">Subjeccts/Grades Categories</label>
                        </div>
                    </div>
                    <!-- /.form-group -->
                </div>
    ...
    <script>
        ...
        jQuery(document).ready(function ($) {
           ...
           //set datatable attributes
            ...
            $('#new_line').on('ifChecked', function(event){
            ...
            $('#remove_first').on('ifChecked', function(event){
            ...
            $('#new_line').on('ifUnchecked', function(event){
        ...
        //unbookmark selected
        $('.unbookmark-selected').on('click', function() {
            ...
            if((globalTeachers.length>0) ){
                ...
                $('#tids').val(globalTeachers);
                var tids = $('#tids').val();

                var tuitionid = $('#tuitionid').val();

                $.ajax({

                    url: '{{url("admin/remove/bookmark/list")}}',
                    type: "post",
                    data: {'ids': tids,'tuitionid':tuitionid, '_token': $('input[name=_token]').val()},

                    success: function (response) {
                        console.log(response);
                        toastr.success('Remove from bookmark list!');
                    }
                ...
                toastr.warning('Please select teachers to add in bookmark list');
            }


        });

        //add to bookmark selected
        $('.bookmark-selected').on('click', function() {
            ...
            if((globalTeachers.length>0) ){
                ...
                $.ajax({
                    ...
                    url: '{{url("admin/add/bookmark/list")}}',
                    type: "post",
                    data: {'ids': tids,'tuitionid':tuitionid, '_token': $('input[name=_token]').val()},

                    success: function (response) {
                        console.log(response);
                        toastr.success('Added to bookmark list!');
                    }
