...
<div class="box box-primary">
    ...
    <div class="box-header with-border">
        ...
        margin-top: 5px;"></i>
        <h1 class="box-title">Tuition Status List</h1>
    </div>
        ...
        <div class="row">
            <div class="col-xs-12">
                ...
                <div class="box">
                    ...
                    <form class="" method="post" action="{{ url('admin/tuition/status') }}" id="filterform">
                    ...
                    <div class="box-header">
                        <a href="{{ url('admin/tuition/status/add') }}" class="btn btn-primary pull-right">
                            ...
                            <tr>
                                ...
                                <td>
                                    <button type="button" class="btn"
                                            style="background: <?php echo $status->color; ?>;height: 20px;width: 15px;">
                                        &nbsp;
                                    </button>
                                </td>
                                <td>
                                    <a class="btn  edit-btn" href="status/update/<?php echo $status->id; ?>" title="Edit" style="padding: 0 0;">
                                        <span class="label label-success">
                                            <i class="fa fa-fw fa-edit" style="font-size: 10px;"></i>
                                        </span>
                                    </a>
                                    <a class="btn  del-btn" href="status/delete/<?php echo $status->id; ?>" onclick="return ConfirmDelete();"
