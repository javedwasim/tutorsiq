                                    ...
                                    <div class="box-body">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <input type="email" class="form-control" id="email" name="email"
                                                               ...
                                                               placeholder="Email"
                                                               maxlength="100" <?php echo isset($teacher_detail->email)&&!empty($teacher_detail->email) ? 'disabled' : ''; ?> >
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group">
                                                    <label for="gender_id" class="col-sm-4 control-label">Gender <span style="color:red;">*</span></label>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group">
                                                    <label for="no_of_children" class="col-sm-4 control-label">
                                                        Added By <span style="color:red;">*</span>
                                                    </label>

                                                    <div class="col-sm-8">
                                                        <select class="form-control select2" id="added_by"
                                                                name="added_by"  data-placeholder="Select Added By" required>
                                                            <option value=""></option>
                                        ...
                                        <!-- Suitable Timings and Tutiion Categories -->
                                        <div class="row">
                                            <div class="col-md-6">

                                                <div class="form-group">
                                                    <label for="suitable_timings" class="col-sm-4 control-label">
                                                        Suitable Timings</label>
                                        ...
                                        <!-- Preferred Institute and Living in  -->
                                        <div class="row">
                                            <div class="col-md-6">

                                                <div class="form-group">
                                                    <label for="institute_id" class="col-sm-4 control-label">
                                                        Preferred Institute</label>

                                                    <div class="col-sm-8">
                                                        <select class="form-control select2 institute"
                                                                multiple="multiple" id="institute_id"
                                                                name="institute_id[]"
                                                                data-placeholder="Select Preferred Institute">
                                                        ...
                                                        <input type="hidden" name="institute_change"
                                                               id="institute_change" value=""/>
                                                    </div>
                                                </div>
                                        ...
                                        <!-- Age and Past Experience Period -->
                                        <div class="row">
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <select class="form-control select2" id="age" name="age"
                                                            ...
                                                            <option value="60"<?php if (isset($teacher_detail->age) && ($teacher_detail->age == 60)) echo "selected"; ?>>
                                                                Sixty Years Plus
                                                            </option>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group">
                                                    <label for="experience" class="col-sm-4 control-label">
                                                        Your Teaching Experience Period</label>
                                        ...
                                        <!-- Experience and  Past Experience Period -->
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label for="past_experience" class="col-sm-12 control-label" style="text-align: left">
                                                        Write About Your Past Teaching Experiecne (Home Tuition or/and Institution)</label>
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <div class="col-sm-12">
                                                        <textarea class="form-control" rows="10" id="past_experience"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <div class="col-sm-12">
                                                        <textarea class="form-control" rows="3" name="strength" id="strength"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <div class="col-sm-12">
                                                        <textarea class="form-control" rows="3" name="reference_for_rent" id="reference_for_rent"
                                                                  maxlength="300"><?php echo isset($teacher_detail->reference_for_rent) ? $teacher_detail->reference_for_rent : ''; ?></textarea>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <div class="col-sm-12">
                                                        <textarea class="form-control" rows="3" name="reference_gurantor" id="reference_gurantor"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <div class="col-sm-12">
                                                        <textarea class="form-control" rows="3" name="about_us" id="about_us"
                                ...
                                <div id="contactinfo" class="panel-collapse collapse in" role="tabpanel"
                                    ...
                                    <div class="box-body">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group">
                                                    <label for="electricity_bill" class="col-sm-4 control-label">
                                                        Scanned Copy Of Electricity/Telephone Bill OR Copy Of Your Permanent Residence</label>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group">
                                                    <label for="cnic_front_image" class="col-sm-4 control-label">
                                                        Original CNIC Scanned Front Image</label>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group">
                                                    <label for="cnic_back_image" class="col-sm-4 control-label">
                                                        Original CNIC Scanned  Back Image</label>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="firstname" class="col-sm-4 control-label">D.O.B </label>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="guardian_contact_no" class="col-sm-4 control-label">Father/Husband's Contact No
                                                        </label>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group">
                                                    <label for="cnic_number" class="col-sm-4 control-label">
                                                        Any Other Emergency Contact No</label>
                                        ...
                                        <!-- Permanent Address -->
                                        <div class="h-holder">
                                            <div class="heading">Permanent Address(As on CNIC)</div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-10">
                                                            <textarea class="form-control" name="address_line1" id="address_line1" cols="138"  maxlength="300"
                                                                      rows="2" style="width: 100%"><?php echo isset($teacher_detail->address_line1) ? $teacher_detail->address_line1 : ''; ?></textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <!-- Present Address -->
                                        <div class="h-holder">
                                            <div class="heading">Present Address</div>

                                            <!-- address-line one and two input-->
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        <label for="address_line1_p" class="col-md-2 control-label">
                                                            Address</label>

                                                        <div class="col-md-10">

                                                            <textarea class="form-control" name="address_line1_p" id="address_line1_p" cols="138"  maxlength="300"
                                                                      rows="2" style="width: 100%"><?php echo isset($teacher_detail->address_line1_p) ? $teacher_detail->address_line1_p : ''; ?></textarea>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-1"> <input type="radio" name="visited" id="dovisit" value="1"
                                                        ...
                                                        <div class="col-sm-1"> <input type="radio" name="visited" id="notvisit" value="0"
                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        <label  class="col-sm-12 control-label" style="text-align: left;font-weight: normal;">
                                                            <textarea class="form-control" name="terms" id="terms" cols="50" rows="10"
                                                                      style="margin: 0px; width: 100%" placeholder="Please Enter ..."
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-1"> <input type="radio" name="accept" id="do"
                                                              <?php  if(isset($teacher_detail->accept)&&($teacher_detail->accept==1)) echo 'checked'; ?> value="1" class="minimal"> </div>
                                                        <label for="do" class="col-sm-5 control-label" style="text-align: left"> I accept</label>

                                                        <div class="col-sm-1"> <input type="radio" name="accept" id="not"
                                                              <?php if(isset($teacher_detail->accept)&&($teacher_detail->accept==0)) echo 'checked'; ?> value="0" class="minimal"> </div>
                                    ...
                                    <div class="box-body">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="country_p" class="col-sm-4 control-label">
                                                        Band Category <span style="color:red;">*</span></label>
                                        ...
                                        <?php if(isset($teacher_labels)): ?>
                                            <div class="form-group">
                                                <label for="labels" class="col-sm-2 control-label">Labels  <span style="color:red;">*</span></label>
                                        ...
                                        <div class="form-group">
                                            <label for="other_detail" class="col-sm-2 control-label">Admin Remarks</label>

                                            <div class="col-sm-10">
                                                <textarea class="form-control" rows="3" name="admin_remarks" placeholder="Enter..."
                                                          maxlength="300"><?php echo isset($teacher_detail->admin_remarks) ? $teacher_detail->admin_remarks : ''; ?></textarea>
                                            </div>
                                        </div>

                                        <div class="form-group">
                                            <label for="other_detail" class="col-sm-2 control-label">Other Details</label>

                                            <div class="col-sm-10">
                                                <textarea class="form-control" rows="3" name="other_detail" placeholder="Enter..."
                                                          maxlength="300"><?php echo isset($teacher_detail->other_detail) ? $teacher_detail->other_detail : ''; ?></textarea>
                                            </div>
                                        </div>
        ...
        jQuery(document).ready(function ($) {
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        if (success == 'saveandadd') {
                            ...
                            var redirect_url = '{{url("admin/teacher/profile/saved")}}';
                            $(".modal-footer").append($('<a class="btn btn-outline" ' +
                                'href="' + redirect_url + '">OK</a>'));
            ...
            $(document).on('change', "#province", function () {
                ...
                $.ajax({
                    ...
                    url: '{{url('admin/load/province/cities')}}',
                    type: "post",
