...
@section('htmlheader_title')
    ...
    <?php if($status != 'add'): ?>
    {{ trans('Admin | Special | Notes | Update') }}
    <?php else: ?>
    {{ trans('Admin | Special | Notes | Add') }}
    <?php endif; ?>
@endsection
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="box box-info">
                    <!-- form start -->
                    <form class="form-horizontal" id="notes" method="post" action="{{ url('admin/notes/save') }}"
                          enctype="multipart/form-data">
                        <input type="hidden" name="_token" value="{{ csrf_token() }}">
                        <input type="hidden" name="status" id="status"
                               value="<?php echo isset($status) ? $status : ''; ?>">
                        <input type="hidden" name="id" id="id"
                               value="<?php echo isset($note->id) ? $note->id : '';?>">
                            ...
                            <div class="panel panel-default">
                                ...
                                <div id="qualification" class="panel-collapse collapse in" role="tabpanel"
                                    ...
                                    <div class="box-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control" id="name"
                                                       value="<?php echo isset($note->name) ? $note->name : ''; ?>"
                                                       name="name" placeholder="Enter Note Name" maxlength="100"
                                                       required>
                                        ...
                                        <div class="form-group">
                                            <label for="note" class="col-sm-2 control-label">Notes<span
                                                        style="color: red">*</span></label>

                                            <div class="col-sm-10">
                                                <textarea class="form-control" rows="3" id="note" name="note" >
                                                    <?php echo isset($note->note) ? $note->note : ''; ?>
                                                </textarea>
                                        ...
                                        <div class="box-footer">
                                            <a href="{{url('admin/notes')}}" class="btn btn-warning pull-right">
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        if (success == 'saveandadd') {
                            ...
                            var redirect_url = '{{url("admin/note/add")}}';
                            toastr.success('Note Save Successfully!');

                        } else {

                            var redirect_url = '{{url("admin/ncmessage")}}';
